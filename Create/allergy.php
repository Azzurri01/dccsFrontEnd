...
<div class="menu">
  <nav>
    <ul>
		...
		<form align="center" class="Allergy-form" action="" method="post">
		<h1 align="left">Create</h1>
		<table>
			<tr>
				<td>Allergy:</td>
				<td><input type="text" name="allergy" class="form-control" id="allergy" placeholder="Enter Allergy"></td>
			</tr>
			<tr>
...
if(isset($_POST['submit']))
{
  ...
  CURLOPT_PORT => "8080",
  CURLOPT_URL => "http://localhost:8080/allergy/create",
  ...
  CURLOPT_POSTFIELDS => "{\"name\": \"$allergy\"}",
...
if ($err) {
  ...
  echo "<p style='margin-left: 660px'>Allergy created successfully!!!</p>";
}
...
{
	echo "<p style='margin-left: 660px'>Error #: No allergy entered!!!</p>";
}
