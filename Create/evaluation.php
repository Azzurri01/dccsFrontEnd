...
<div class="menu">
  <nav>
    <ul>
		...
		<li> <a href="/Frontend/php/Evaluation.html">Evaluation</a> </li>
    </ul>
  </nav>
  </div>
		
		<form align="center" class="Evaluation-form" action="" method="post">
		<h1 align="left">Create</h1>
		<table>
			<tr>
				<td>Evaluation:</td>
				<td><input type="text" name="evaluation" class="form-control" id="evaluation" placeholder="Enter Evaluation"></td>
			</tr>
			<tr>
...
if(isset($_POST['submit']))
{
  ...
  CURLOPT_PORT => "8080",
  CURLOPT_URL => "http://localhost:8080/evaluation/create",
  ...
  CURLOPT_POSTFIELDS => "{\"rating\": \"$evaluation\"}",
...
if ($err) {
  ...
  echo "<p style='margin-left: 660px'>Evaluation created successfully!!!</p>";
}
...
{
	echo "<p style='margin-left: 660px'>Error #: No evaluation entered!!!</p>";
}
