...
<div class="menu">
  <nav>
    <ul>
		...
		<li> <a href="/Frontend/php/Drawing.html">Drawing</a> </li>
    </ul>
  </nav>
  </div>
		
		<form align="center" class="Drawing-form" action="" method="post">
		<h1 align="left">Create</h1>
		<table>
			<tr>
				<td>Drawing:</td>
				<td><input type="text" name="drawing" class="form-control" id="drawing" placeholder="Enter Drawing"></td>
			</tr>
			<tr>
...
if(isset($_POST['submit']))
{
  ...
  CURLOPT_PORT => "8080",
  CURLOPT_URL => "http://localhost:8080/drawing/create",
  ...
  CURLOPT_POSTFIELDS => "{\"shapes\": \"$drawing\"}",
...
if ($err) {
  ...
  echo "<p style='margin-left: 660px'>Drawing created successfully!!!</p>";
}
...
{
	echo "<p style='margin-left: 660px'>Error #: No drawing entered!!!</p>";
}
