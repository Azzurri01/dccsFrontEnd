...
<div class="menu">
  <nav>
    <ul>
		...
		<form align="center" class="Counting-form" action="" method="post">
		<h1 align="left">Create</h1>
		<table>
			<tr>
				<td>Counting:</td>
				<td><input type="text" name="counting" class="form-control" id="counting" placeholder="Enter Counting"></td>
			</tr>
			<tr>
...
{
	if(!empty($_POST['counting']))
	{
		curl_setopt_array($curl, array(
  CURLOPT_PORT => "8080",
  CURLOPT_URL => "http://localhost:8080/counting/create",
  ...
  CURLOPT_POSTFIELDS => "{\"number\": \"$counting\"}",
...
if ($err) {
  ...
  echo "<p style='margin-left: 660px'>Counting created successfully!!!</p>";
}
...
{
	echo "<p style='margin-left: 660px'>Error #: No counting entered!!!</p>";
}
