...
$allColours = file_get_contents($response);
$decodeColours = json_decode($response);
//print_r($allColours);
...
<?php foreach($decodeColours as $colours) 
{ ?>
	<tr>
		<td><?php echo $allColours->id; ?></td>
		<td><?php echo $allColours->colour; ?></td>
	</tr>
<?php } ?>
